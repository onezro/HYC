  ...
  <div class="firstdata">
    ...
    <el-dialog title="添加" :visible.sync="dialogVisible">
      ...
      >
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="检查目标" prop="subItemAim">
              <el-input
                type="textarea"
          ...
          ></el-col>
          <el-col :span="12"
            ><el-form-item label="检验方法" prop="subItemMethod">
              <el-input
                type="textarea"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="检查标准" prop="subItemBasic">
              <el-input
                type="textarea"
          ...
          ></el-col>
          <el-col :span="12">
            <el-form-item label="解决办法" prop="subItemSolution">
              <el-input
                type="textarea"
...
export default {
  ...
  methods: {
    ...
    addFormOpen() {
      ...
      this.inputValue(this.addForm.step);
    },
    addCancel() {
